...
public interface FavoriteRepository extends JpaRepository<Favorite, String> {
    ...
    @Modifying
    @Query(value = "INSERT IGNORE INTO favorites (id, user_id, music_library_id, created_at) VALUES (:id, :userId, :musicLibraryId, CURRENT_TIMESTAMP)", nativeQuery = true)
    int insertIgnore(@Param("id") String id, @Param("userId") String userId, @Param("musicLibraryId") String musicLibraryId);
