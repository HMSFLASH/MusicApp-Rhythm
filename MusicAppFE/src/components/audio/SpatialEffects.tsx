      ...
      <div className="bg-[#0a0a0a] rounded-2xl border border-white/5 shadow-2xl p-8 flex flex-col gap-8">
        <div className="flex items-center gap-3 border-b border-white/10 pb-4">
          <button aria-label="Action" 
            ...
            className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${playerState.fxEnabled.reverb ? 'bg-[#ff00ff]/20 text-[#ff00ff] shadow-[0_0_15px_rgba(255,0,255,0.4)]' : 'bg-white/5 text-white/80 hover:bg-white/10'}`}
          >
            <Power size={14} />
          </button>
          <div>
      ...
      <div className="bg-[#0a0a0a] p-8 rounded-2xl border border-white/5 shadow-2xl flex flex-col gap-8">
        <div className="flex items-center justify-between border-b border-white/10 pb-4">
          ...
          <button aria-label="Action"
            ...
            className={`w-10 h-10 flex-shrink-0 rounded-full flex items-center justify-center transition-all ${playerState.fxEnabled.stereo ? 'bg-[#9d00ff]/20 text-[#9d00ff] shadow-[0_0_15px_rgba(157,0,255,0.4)]' : 'bg-white/5 text-white/80 hover:bg-white/10'}`}
          >
            <Power size={18} />
          </button>
        </div>
